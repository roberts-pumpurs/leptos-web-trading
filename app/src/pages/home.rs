                        ...
                        <dl class="grid max-w-xl grid-cols-1 gap-x-10 gap-y-16 lg:max-w-none lg:grid-cols-3">
                            <div class="flex flex-col">
                                ...
                                <dt class="flex mt-5 items-center gap-x-3 text-2xl font-semibold leading-7 text-gray-900">
                                    <svg class="h-7 w-7 flex-none text-indigo-600" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                ...
                                <dd class="mt-4 flex flex-auto flex-col text-lg leading-7 text-gray-600">
                                    <p class="flex-auto">
                                        "Performance and Reactivity of Leptos"
                                    </p>
                                    <p class="mt-6">
                                        <a
                            ...
                            <div class="flex flex-col">
                                ...
                                <dd class="mt-4 flex flex-auto flex-col text-lg leading-7 text-gray-600">
                                    <p class="flex-auto">
                                        "Robustness and Type-safety of Rust"
                                    </p>
                                    <p class="mt-6">
                                        <a
